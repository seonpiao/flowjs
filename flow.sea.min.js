define("./index",["./util/class","./flow","./step","./condition","./input"],function(a,b,c){window.Flowjs={V:"0.1.0",Class:a("./util/class"),Flow:a("./flow"),Step:a("./step"),Condition:a("./condition"),Input:a("./input")}});
define("./util/class",["./baseobject"],function(a,b,c){var d=a("./baseobject"),e=function(a){var b=a.extend||d,c=function(){},f=a.plugins||[];c.prototype=b.prototype;var g=a.construct||function(){},h=a.properties||{},i=a.methods||{},j=a.statics||{},k=a.abstract===!0,l=new c,m;for(m in l)l.hasOwnProperty(m)&&delete l[m];for(m in h)l[m]=h[m];for(m in i)l[m]=i[m];for(var n=0;n<f.length;n++){var o=f[n];for(m in o)l[m]=o[m]}if(!k)for(var p in l)if(l[p]==e.abstractMethod)throw new Error("Abstract method ["+p+"] is not implement.");l.constructor=g,l.superclass=b,g.prototype=l;for(m in j)g[m]=j[m];return g};e.abstractMethod=function(){throw new Error("Not implement.")},c.exports=e});
...
define("./input",["./util/class","./condition","./util/extend"],function(a,b,c){var d=a("./util/class"),e=a("./condition"),f=a("./util/extend"),g=d({extend:e,construct:function(a){a=a||{},this.callsuper(a),this._inputs=a.inputs||{},this._binded=!1},"abstract":!0,methods:{_once:function(a){this._binded||(this._binded=!0,a())},inputs:function(a){var b={};return b.cases=a.inputs,this.cases(b)}}});c.exports=g});
define("./condition",["./util/class","./step","./util/extend"],function(a,b,c){var d=a("./util/class"),e=a("./step"),f=a("./util/extend"),g=d({extend:e,construct:function(a){a=a||{},this.callsuper(a),this._cases=a.cases||{},this._default=a.defaultCase},"abstract":!0,methods:{_select:function(a,b){var c=this._cases[a]||this._default;c(b)},cases:function(a){if(!a)return{defaultCase:this._default,cases:this._cases};a.cases&&f(this._cases,a.cases),a.defaultCase&&(this._default=a.defaultCase)}}});c.exports=g});

define("./index",["./util/class","./flow","./step","./condition","./input"],function(a,b,c){window.Flowjs={V:"0.3.0",Class:a("./util/class"),Flow:a("./flow"),Step:a("./step"),Condition:a("./condition"),Input:a("./input")}});
...
define("./util/deepExtend",[],function(a,b,c){var d=Array.isArray||function(a){return Object.prototype.toString.call(a)=="[object Array]"},e=function(a){return Object.prototype.toString.call(a)=="[object Object]"},f=function(a,b){var c,g,h,i,j,k=1,l=arguments.length,m=a,n,o;for(;k<l;k++){g=arguments[k];if(e(g)||d(g))for(h in g){i=m[h],j=g[h];if(i===j)continue;j&&(e(j)||(n=d(j)))?(n?(n=!1,o=i&&d(i)?i:[]):o=i&&e(i)?i:{},m[h]=f(o,j)):j!==undefined&&(m[h]=j)}}return m};c.exports=f});
...
define("./util/flowData",["./class","./tool"],function(a,b,c){var d=a("./class"),e=a("./tool"),f=d({construct:function(a){this._data={}},methods:{getData:function(a){var b={},c=(new Date).getTime();if(e.isArray(a)){var d=a.length;for(var f=0;f<d;f++){var g=a[f];this._data.hasOwnProperty(g)&&(b[g]=this._data[g])}return b}return this._data[a.toString()]},setData:function(a,b){return this._data[a]=b,!1}}});c.exports=f});